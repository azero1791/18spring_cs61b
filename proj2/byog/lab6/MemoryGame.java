...
public class MemoryGame {
    ...
    public String generateRandomString(int n) {
        ...
        String answer = "";
        for (int i = 0; i < n; i++) {
            int randIndex = rand.nextInt(0, CHARACTERS.length);
            answer += CHARACTERS[randIndex];
        }
        return answer;
    }
    ...
    public String solicitNCharsInput(int n) {
        ...
        String keystokes = "";
        while (true) {
            if (keystokes.length() == n) {
                break;
            }   else if (StdDraw.hasNextKeyTyped()) {
                keystokes += StdDraw.nextKeyTyped();
            }
        }
        return keystokes;
    }
    ...
    public void startGame() {
        ...
        while (true) {
            ...
            String keystrokes = solicitNCharsInput(round);

            if (!keystrokes.equals(randomString)) {
                gameOver = true;
